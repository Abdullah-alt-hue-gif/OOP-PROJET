...
void KingdomEvent::applyEffects(EventType type, Population& pop,
    ...
    case EventType::FAMINE:
        cout << "A Famine Broke in your Kingdom\n";
        cout << "Food storages decreased by half\n";
    ...
    case EventType::FLOOD:
        cout << "KIngdom is Damaged By A Massive Flood!\n";
    ...
    case EventType::TORNADO:
        cout << "A Tornado Caused Some Serious Damage In The Kingdom\n";
        res.gatherWood(-res.getWood() / 2);
    ...
    case EventType::CORRUPTION:
        cout << "Corrupton Scandal Against The King!\n";
    ...
    case EventType::REVOLT: {
        cout << "PEASANTS REVOLTED AGAINST THE KING!\n";
